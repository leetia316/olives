...
public class SysUserController extends JavaEEFrameworkBaseController<SysUser> implements Constant {
	...
	public String banner(HttpServletRequest request, HttpServletResponse response) throws IOException {
		return "back/systemmanage/banner";
	}
	@RequestMapping("/groupmanage")
	public String olivesGroup(HttpServletRequest request, HttpServletResponse response) throws IOException {
		return "back/groupmanage/groupList";
	}
